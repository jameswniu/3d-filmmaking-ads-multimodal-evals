...
The newest cut on this page is the first commentary, the author's take that artificial intelligence reflects the people who made it, shot as a spot and then edited like one. It opens on a detail of the set with the voice already going and the first two words in bold over it; her face arrives a second in; the scene changes on a hard cut right after the line about the image of God, and again on an insert of a mug at rest on a counter; the camera drifts on every shot, in on the study, out at the window, in again at dusk. Twenty-seven seconds, three sets, three wardrobes, one voice. Each scene is its own short render stitched in the edit, which is why the thirty-second reversal defect described below never appears: no single shot lives long enough to hit it. The three short shots billed one credit each as read off the balance, their three wardrobe looks at two apiece, and the edit cost nothing, because it is post. The level probe flags this clip harder than anything else here, 169.1 of scene wander against a bar of 8.0, because it assumes a clip holds one scene, and this one breaks that assumption on purpose. The lip-sync verdict fails it the same way it fails ten of the twelve singles. Both numbers are in the table.

<p align="center"><img src="https://raw.githubusercontent.com/jameswniu/3d-filmmaking-ads-multimodal-evals/archive-media/shoot-20260822-film-image-v2b.gif" alt="Three-scene cut: night study, bright window, dusk kitchen" width="62%"><br><sub><b>In the image of man.</b> <a href="https://github.com/jameswniu/3d-filmmaking-ads-multimodal-evals/raw/archive-media/shoot-20260822-film-image-v2.mp4">&#9654; with sound (0:27)</a></sub></p>
...
| film-image | 2 | -200 early | **FAIL** | **51.1 / 169.1 / 105.1** | 2.65 | 5.55 | 0.00 | 0.502 |
