...
The newest cut on this page is the first commentary, the author's take that artificial intelligence reflects the people who made it, re-shot on the premium engine tier and edited the way a broadcast spot is edited. Nine shots in twenty-seven seconds, and the camera never moves. Earlier cuts drifted and zoomed; the drift jittered, because the zoom filter rounds its crop window to whole pixels, and the author called the motion pointless twice, so every shot in this cut is a locked native-pixel trim and the cuts carry all the energy. Her face holds the hook, the central claim and the close, about six in ten seconds of screen time, and the middle runs as voice-over across detail inserts, a leather journal under the lamp while she says everything we ever wrote, the sweater and window light, the mug, the bottles on the counter, each insert holding its key words in bold. A quiet piano bed sits under the voice and swells at the end, generated on a licensed music model and mixed low. The three premium renders cost twenty-five credits as read off the balance before and after, against three credits for the same three shots on the flat tier, and the difference is the body language. Each scene is its own short render stitched in the edit, which is why the thirty-second reversal defect described below never appears: no single shot lives long enough to hit it. The level probe still flags this clip harder than anything else here, 179.8 of face wander against a bar of 8.0, because it assumes a clip holds one scene, and this cut changes scene eight times on purpose. The lip-sync verdict fails it the same way it fails ten of the twelve singles. Both numbers are in the table.

<p align="center"><img src="https://raw.githubusercontent.com/jameswniu/3d-filmmaking-ads-multimodal-evals/archive-media/shoot-20260822-film-image-v5.gif" alt="Three-scene cut: night study, bright window, dusk kitchen" width="62%"><br><sub><b>In the image of man.</b> <a href="https://github.com/jameswniu/3d-filmmaking-ads-multimodal-evals/raw/archive-media/shoot-20260822-film-image-v5.mp4">&#9654; with sound (0:27)</a></sub></p>
...
| film-image | 2 | -200 early | **FAIL** | **179.8 / 168.0 / 116.9** | 2.83 | 5.58 | 0.00 | 0.400 |
