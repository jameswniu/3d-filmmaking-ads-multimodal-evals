...
The newest cut on this page is the first commentary rebuilt from zero, the author's take that artificial intelligence reflects the people who made it. After four edits of the original footage still read as a rendering, everything was thrown out and remade in one pass, new words drafted in the author's own voice and cut to sixty, four new scenes generated and gated from scratch (a night skyline, a breakfast table, an amber wall, a golden one), four new takes on the premium engine tier, and a fresh piano bed. Nine shots in twenty-three seconds, and the camera never moves, because the author called the drift pointless twice and he was right; every shot is a locked native-pixel trim, cut on the clause boundaries of her own captions, and the cuts and the music carry the energy. Then the author watched it and said it was media now but not yet entertainment, so the same footage was recut in trailer grammar: a four-image flash barrage before the first second is out, a whoosh into each flash and a hit on her reveal, type that slams one phrase at a time, the voice running over a black frame for nobody added the flaws, and a title card that hands the last line back to the first. Fifteen visual events in twenty-five seconds, every frame still locked, and a pulsing bed with three synced hits in place of the polite piano. The whole pass cost thirty-eight credits as read off the balance before and after, fourteen on seven look generations (two scenes failed the background gates twice before a plain wall passed) and twenty-four on the four renders; the trailer recut cost nothing, because it is post. The level probe flags it harder than anything else here, 200.7 of scene wander against a bar of 8.0, because it assumes a clip holds one scene, and this cut changes what is on screen fifteen times on purpose. The lip-sync verdict, which fails ten of the twelve singles and failed every earlier cut of this film, passes this one. Both numbers are in the table.

<p align="center"><img src="https://raw.githubusercontent.com/jameswniu/3d-filmmaking-ads-multimodal-evals/archive-media/shoot-20260822-film2-v2.gif" alt="Three-scene cut: night study, bright window, dusk kitchen" width="62%"><br><sub><b>In the image of man.</b> <a href="https://github.com/jameswniu/3d-filmmaking-ads-multimodal-evals/raw/archive-media/shoot-20260822-film2-v2.mp4">&#9654; with sound (0:26)</a></sub></p>
...
| film-image | 1 | n/a | PASS | **149.0 / 200.7 / 139.2** | 1.89 | 4.07 | 3.56 | 0.465 |
