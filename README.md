...
The newest cut on this page is the first commentary rebuilt from zero, the author's take that artificial intelligence reflects the people who made it. After four edits of the original footage still read as a rendering, everything was thrown out and remade in one pass, new words drafted in the author's own voice and cut to sixty, four new scenes generated and gated from scratch (a night skyline, a breakfast table, an amber wall, a golden one), four new takes on the premium engine tier, and a fresh piano bed. Nine shots in twenty-three seconds, and the camera never moves, because the author called the drift pointless twice and he was right; every shot is a locked native-pixel trim, cut on the clause boundaries of her own captions, and the cuts and the music carry the energy. Her face opens the film on the first word and closes it on the last; two inserts carry the middle, a city at night and her own notebook, each holding its key words in bold. The whole pass cost thirty-eight credits as read off the balance before and after, fourteen on seven look generations (two scenes failed the background gates twice before a plain wall passed) and twenty-four on the four renders. The level probe flags it harder than anything else here, 182.4 of scene wander against a bar of 8.0, because it assumes a clip holds one scene, and this cut changes scene eight times on purpose. The lip-sync verdict fails it the same way it fails ten of the twelve singles. Both numbers are in the table.

<p align="center"><img src="https://raw.githubusercontent.com/jameswniu/3d-filmmaking-ads-multimodal-evals/archive-media/shoot-20260822-film2.gif" alt="Three-scene cut: night study, bright window, dusk kitchen" width="62%"><br><sub><b>In the image of man.</b> <a href="https://github.com/jameswniu/3d-filmmaking-ads-multimodal-evals/raw/archive-media/shoot-20260822-film2.mp4">&#9654; with sound (0:23)</a></sub></p>
...
| film-image | 2 | n/a | **FAIL** | **118.4 / 182.4 / 140.7** | 2.43 | 4.60 | 0.00 | 0.385 |
