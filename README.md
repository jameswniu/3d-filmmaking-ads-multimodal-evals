...
The newest cut on this page is the first commentary re-shot as a spot. The hook line opens cold in a night study, the scene changes on a hard cut at eight seconds and again at eighteen, three sets, three wardrobes, one voice, twenty-eight seconds. Each scene is its own short render stitched in the edit, which is why the thirty-second reversal defect described below never appears: no single shot lives long enough to hit it. The three short shots billed one credit each as read off the balance, and their three wardrobe looks at two apiece. The level probe flags this clip harder than anything else here, 165.9 of scene wander against a bar of 8.0, because it assumes a clip holds one scene, and this one breaks that assumption on purpose. The lip-sync verdict fails it the same way it fails ten of the twelve singles. Both numbers are in the table.

<p align="center"><img src="https://raw.githubusercontent.com/jameswniu/3d-filmmaking-ads-multimodal-evals/archive-media/shoot-20260822-film-image.gif" alt="Three-scene cut: night study, bright window, dusk kitchen" width="62%"><br><sub><b>In the image of man, three scenes.</b> <a href="https://github.com/jameswniu/3d-filmmaking-ads-multimodal-evals/raw/archive-media/shoot-20260822-film-image.mp4">&#9654; with sound (0:28)</a></sub></p>
