...
The newest cut on this page no longer has a presenter, because the author watched every polished talking-head version and said the same thing each time, that it was correct and not entertaining, and the research backed him: the ads that actually entertain dramatize the thesis instead of stating it. So the thesis, that artificial intelligence is made in the image of the people who trained it, now plays as six generated vignettes of the training data itself: a rollercoaster proposal mid-drop, two strangers laughing under one umbrella, a man screaming at a parking meter in the rain, an office worker photocopying her own face, a child teaching calculus to a golden retriever, a grandmother drag-racing a mobility scooter through a supermarket. The voice-over lands one clause on each. The avatar appears exactly once, for two seconds, to say made in our image, and then the screen goes black and the narrator admits what she is: I know. I was there for all of it. Twenty seconds, twelve cuts, a pulsing bed with synced hits. The author chose this suspense order over a faster thesis-first flash cut that also exists on the media branch, and sent the closing card back four times: first for a film-title serif, then for a size up with real letter-spacing, which the video encoder's text filter cannot do, so the card is rendered as an image and composited, then for the typeface itself, which went from Didot to Baskerville after a pairwise research pass and a test that pushed six candidates through the same encode settings the clips ship with, where Didot's hairlines came back grey, and last for size again, after a phone-scale check showed the second line sitting at the floor of legibility on a 390-pixel screen. The scenes came from the vendor's video agent, seven generations for six keepers (a murky infinity-reflection scene was culled and re-rolled as the grandmother), twenty-nine credits read off the balance before and after, five for the first probe scene and four apiece once the queue warmed; the flash-cut variant cost twenty more. The probes are harder on this cut than any presenter version, three flags: the level probe reads twelve cuts as wander, and the eye and background gates flag the vignettes as too busy, which they are, on purpose, because the busy is the entertainment. The lip-sync verdict passes. All numbers are in the table.

<p align="center"><img src="https://raw.githubusercontent.com/jameswniu/3d-filmmaking-ads-multimodal-evals/archive-media/shoot-20260822-film3-v7.gif" alt="Six-vignette cut with a single avatar reveal and a black title card" width="62%"><br><sub><b>In the image of man.</b> <a href="https://github.com/jameswniu/3d-filmmaking-ads-multimodal-evals/raw/archive-media/shoot-20260822-film3-v7.mp4">&#9654; with sound (0:20)</a></sub></p>

The worst number on this board belongs to the level probe, which flags every one of the thirteen for luminance wander, with the brokerage variants near 250 against a bar of 8.0, because a montage is wander by construction; the lip-sync probe fails eleven of the thirteen, and on the remade spots it is watching crowd scenes where nobody on camera is the narrator; the eye model rejects eleven on background brightness; three run late on sync. They are listed before the clips because a report card that shows only the good marks is an advert, and because two of those probes are the ones this page already calls unreliable: the level bar was calibrated from a single clip, and the lip-sync verdict is the same metric that fails the hero render above.

Five advertisements for brands that do not exist, remade in the vignette grammar of the cut above after the author looked at the first version, five identical talking heads, and asked what any of them was selling. Each spot now dramatizes one product in three generated scenes with one absurd beat apiece, a coffee subscription, on-call software, a neighbourhood brokerage, a sleep app, a travel agency, and the avatar appears once at the end, in that brand's wardrobe look, to close the sale and speak the standing promise that the pipeline behind the spot is public, link under the video. The brokerage closer was rendered three times from one template with three first names, which is what a variant pool looks like before an ad platform picks from it. Sixteen scenes from the vendor's video agent at four credits each, one of them re-rolled for a clearer product beat, and seven closers on the premium tier, 116 credits read off the balance before and after. Every narration and closer was drawn three times in the cloned voice and kept only when the transcription round trip matched the script, which is how the software brand got caught coming back as Mantern Street once and re-drawn. The five short commentaries beneath them are unchanged, the author's own positions voiced in the first person on the flat tier at two credits each, with the words credited on the frame. Every clip is under thirty seconds by design.

<table>
  <tr>
    <td width="20%" align="center" valign="top"><img src="https://raw.githubusercontent.com/jameswniu/3d-filmmaking-ads-multimodal-evals/archive-media/shoot-20260822-ad2-orchard.gif" alt="Orchard Hill Coffee, a fictional coffee subscription, three vignettes and a closer" width="100%"><br><sub><b>Orchard Hill Coffee.</b> <a href="https://github.com/jameswniu/3d-filmmaking-ads-multimodal-evals/raw/archive-media/shoot-20260822-ad2-orchard.mp4">&#9654; with sound</a></sub></td>
    <td width="20%" align="center" valign="top"><img src="https://raw.githubusercontent.com/jameswniu/3d-filmmaking-ads-multimodal-evals/archive-media/shoot-20260822-ad2-lantern.gif" alt="Lantern Street, fictional on-call software, three vignettes and a closer" width="100%"><br><sub><b>Lantern Street.</b> <a href="https://github.com/jameswniu/3d-filmmaking-ads-multimodal-evals/raw/archive-media/shoot-20260822-ad2-lantern.mp4">&#9654; with sound</a></sub></td>
    <td width="20%" align="center" valign="top"><img src="https://raw.githubusercontent.com/jameswniu/3d-filmmaking-ads-multimodal-evals/archive-media/shoot-20260822-ad2-harbor-maya.gif" alt="Harbor Lane Realty, a fictional brokerage, three vignettes and one closer rendered with three first names" width="100%"><br><sub><b>Harbor Lane Realty.</b> <a href="https://github.com/jameswniu/3d-filmmaking-ads-multimodal-evals/raw/archive-media/shoot-20260822-ad2-harbor-maya.mp4">&#9654; Maya</a> <a href="https://github.com/jameswniu/3d-filmmaking-ads-multimodal-evals/raw/archive-media/shoot-20260822-ad2-harbor-daniel.mp4">&#9654; Daniel</a> <a href="https://github.com/jameswniu/3d-filmmaking-ads-multimodal-evals/raw/archive-media/shoot-20260822-ad2-harbor-elena.mp4">&#9654; Elena</a></sub></td>
    <td width="20%" align="center" valign="top"><img src="https://raw.githubusercontent.com/jameswniu/3d-filmmaking-ads-multimodal-evals/archive-media/shoot-20260822-ad2-quiet.gif" alt="Quiet Hours, a fictional sleep app, three vignettes and a closer" width="100%"><br><sub><b>Quiet Hours.</b> <a href="https://github.com/jameswniu/3d-filmmaking-ads-multimodal-evals/raw/archive-media/shoot-20260822-ad2-quiet.mp4">&#9654; with sound</a></sub></td>
    <td width="20%" align="center" valign="top"><img src="https://raw.githubusercontent.com/jameswniu/3d-filmmaking-ads-multimodal-evals/archive-media/shoot-20260822-ad2-slowroad.gif" alt="Slow Road Travel, a fictional travel agency, three vignettes and a closer" width="100%"><br><sub><b>Slow Road Travel.</b> <a href="https://github.com/jameswniu/3d-filmmaking-ads-multimodal-evals/raw/archive-media/shoot-20260822-ad2-slowroad.mp4">&#9654; with sound</a></sub></td>
  </tr>
  <tr>
