...
The newest cut on this page no longer has a presenter, because the author watched every polished talking-head version and said the same thing each time, that it was correct and not entertaining, and the research backed him: the ads that actually entertain dramatize the thesis instead of stating it. This cut also leads with the conclusion, on his call, because a cold viewer who hears we trained it without knowing what it is has ambiguity, not curiosity. So the first voice line is the thesis itself, artificial intelligence is made in the image of man, over a rollercoaster proposal mid-drop, and then the training data plays: a bride karate-kicking a pinata, strangers laughing under one umbrella, a man screaming at a parking meter, an office worker photocopying her own face, a child teaching calculus to a golden retriever. Then the film stops explaining and starts sprinting, white flash cuts at faster speed through a grandmother drag-racing a mobility scooter, an astronaut slow-dancing with an old woman in a laundromat, a toddler chairing a boardroom, a man tucking a baguette into bed, a six-image recap barrage, and the avatar appears exactly once, for two seconds, to say made in our image. Black. The narrator admits what she is: I know. I was there for all of it. Twenty-five seconds, roughly twenty visual events, a pulsing bed with a riser and synced hits. Eleven video-agent generations across two rounds for ten keepers, forty-nine credits read off the balance before and after across both rounds. The probes flag three things: the level probe reads the cuts as wander, the eye gate flags the vignettes as bright and busy, and the scene probe returned nothing it could parse, all printed in the table, because the busy is the entertainment and the page does not round. The lip-sync verdict passes.

<p align="center"><img src="https://raw.githubusercontent.com/jameswniu/3d-filmmaking-ads-multimodal-evals/archive-media/shoot-20260822-film3-v2.gif" alt="Three-scene cut: night study, bright window, dusk kitchen" width="62%"><br><sub><b>In the image of man.</b> <a href="https://github.com/jameswniu/3d-filmmaking-ads-multimodal-evals/raw/archive-media/shoot-20260822-film3-v2.mp4">&#9654; with sound (0:25)</a></sub></p>
...
| film-image | 3 | n/a | PASS | **136.0 / 167.9 / 131.3** | **9.40** | **n/a** | 0.00 | 0.662 |
